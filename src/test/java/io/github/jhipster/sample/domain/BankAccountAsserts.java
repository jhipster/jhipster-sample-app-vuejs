...
public class BankAccountAsserts {
    ...
    public static void assertBankAccountUpdatableFieldsEquals(BankAccount expected, BankAccount actual) {
        assertThat(expected)
            ...
            .satisfies(
                e -> assertThat(e.getLastOperationDuration()).as("check lastOperationDuration").isEqualTo(actual.getLastOperationDuration())
            )
            .satisfies(
                e -> assertThat(e.getMeanOperationDuration()).as("check meanOperationDuration").isEqualTo(actual.getMeanOperationDuration())
            )
            .satisfies(
            ...
            .satisfies(
                e ->
                    assertThat(e.getAttachmentContentType())
                        .as("check attachment contenty type")
                        .isEqualTo(actual.getAttachmentContentType())
            )
